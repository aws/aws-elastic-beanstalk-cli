    ...
    def test_get_solution_stack(self, mock_beanstalk):
        solutions = {
            ...
            "solution_stacks": [
                ...
                "64bit Debian jessie v2.6.0 running Go 1.4 (Preconfigured - Docker)",
                "64bit Debian jessie v2.6.0 running Python 3.4 (Preconfigured - Docker)",
                "64bit Amazon Linux 2017.03 v2.5.0 running Java 8",
                "64bit Amazon Linux 2017.03 v2.5.0 running Java 7",
                "64bit Amazon Linux 2017.03 v2.4.1 running Go 1.7",
                ...
                "64bit Amazon Linux 2017.03 v2.2.1 running Packer 1.0.0"
            ]
        }
