...
class TestFactory(TestCase):
    ...
    def test_make_container_fs_handler(self, dockerrun_mock):
        dockerrun_mock.get_dockerrun.return_value = dummy.get_dockerrun_dict()
    ...
    @patch('ebcli.containers.factory.dockerrun')
    def test_make_multicontainer_fs_handler(self, dockerrun_mock):
        dockerrun_mock.get_dockerrun.return_value = dummy.DOCKERRUN_DICT
    ...
    @patch('ebcli.containers.factory._determine_platform')
    @patch('ebcli.containers.factory.containerops')
    def test_make_container_not_supported(
        self,
        containerops_mock,
        _determine_platform_mock,
    ):
        containerops_mock.is_multi.return_value = False
        containerops_mock.is_generic.return_value = False
    ...
    @patch('ebcli.containers.factory._determine_platform')
    @patch('ebcli.containers.factory.containerops')
    def test_make_container_multi(
        self,
        containerops_mock,
        _determine_platform_mock,
        make_multicontainer_fs_handler,
    ):
        containerops_mock.is_multi.return_value = True
        containerops_mock.is_generic.return_value = False
        containerops_mock.is_preconfigured.return_value = False
    ...
    @patch('ebcli.containers.factory._determine_platform')
    @patch('ebcli.containers.factory.containerops')
    def test_container_preconfigured(
        self,
        containerops_mock,
        _determine_platform_mock,
        make_container_fs_handler_mock,
        ...
        containerops_mock.is_multi.return_value = False
        containerops_mock.is_generic.return_value = False
        containerops_mock.is_preconfigured.return_value = True
        make_container_fs_handler_mock.return_value = dummy.CONTAINER_FS_HANDLER
        _determine_platform_mock.return_value = dummy.SOLN_STK
