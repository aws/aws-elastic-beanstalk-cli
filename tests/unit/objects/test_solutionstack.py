...
class TestSolutionStack(unittest.TestCase):
    ...
    def test_solution_string_sorting(self):
        solution_stacks = [
            ...
            '64bit Amazon Linux 2018.03 v2.11.0 running GlassFish 5.0 Java 8 (Preconfigured - Docker)',
            '64bit Amazon Linux 2018.03 v2.11.0 running GlassFish 4.1 Java 8 (Preconfigured - Docker)',
        ]
