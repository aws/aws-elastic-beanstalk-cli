...
class TestEbIgnore(unittest.TestCase):
    ...
    def test_get_ebignore_list__includes_dotted_files_in_the_ebignore_list(self, get_ebignore_location_mock, get_project_root_mock):
...
"""
    ...
    @patch('ebcli.core.fileoperations.get_project_root')
    @patch('ebcli.core.fileoperations.get_ebignore_location')
    def test_get_ebignore_list__includes_regular_files_in_the_ebignore_list(self, get_ebignore_location_mock, get_project_root_mock):
        get_project_root_mock.return_value = os.getcwd()
        get_ebignore_location_mock.return_value = os.path.join(os.getcwd(), '.ebignore')
...
""".format(os.path.sep)
    ...
    @patch('ebcli.core.fileoperations.get_project_root')
    @patch('ebcli.core.fileoperations.get_ebignore_location')
    def test_get_ebignore_list__includes_directories_in_the_ebignore_list(self, get_ebignore_location_mock, get_project_root_mock):
        get_project_root_mock.return_value = os.getcwd()
        get_ebignore_location_mock.return_value = os.path.join(os.getcwd(), '.ebignore')
...
"""
    ...
    @patch('ebcli.core.fileoperations.get_project_root')
    @patch('ebcli.core.fileoperations.get_ebignore_location')
    def test_get_ebignore_list__includes_filenames_with_spaces_in_ignore_list(self, get_ebignore_location_mock, get_project_root_mock):
        get_project_root_mock.return_value = os.getcwd()
        get_ebignore_location_mock.return_value = os.path.join(os.getcwd(), '.ebignore')
...
"""
    ...
    @patch('ebcli.core.fileoperations.get_project_root')
    @patch('ebcli.core.fileoperations.get_ebignore_location')
    def test_get_ebignore_list__includes_filenames_with_exclamations_in_ignore_list(self, get_ebignore_location_mock, get_project_root_mock):
        get_project_root_mock.return_value = os.getcwd()
        get_ebignore_location_mock.return_value = os.path.join(os.getcwd(), '.ebignore')
...
"""
    ...
    @patch('ebcli.core.fileoperations.get_project_root')
    @patch('ebcli.core.fileoperations.get_ebignore_location')
    def test_get_ebignore_list__includes_files_with_unicode_names(self, get_ebignore_location_mock, get_project_root_mock):
        get_project_root_mock.return_value = os.getcwd()
        get_ebignore_location_mock.return_value = os.path.join(os.getcwd(), '.ebignore')
...
"""
        ...
        self.assertEqual(
            set(['哈哈', '昨夜のコンサートは最高でした。', 'ändrar något i databasen', '.ebignore']),
            set(paths_to_ignore)
        )
