...
class TestDockerEnvvarCollector(TestCase):
    def test_empty_environment(self):
        self.assertDictEqual({}, EnvvarCollector().get_envvars())
    ...
    def test_merge_non_overlapping_envs(self):
        ...
        self.assertDictEqual(expected_envvars, env0.merge(env1).get_envvars())
        self.assertDictEqual(expected_envvars, env1.merge(env0).get_envvars())
    ...
    def test_merge_overlapping_and_vars_to_remove(self):
        ...
        self.assertEqual({'a': '5'}, env0.merge(env1).get_envvars())
        self.assertEqual({'a': '0'}, env1.merge(env0).get_envvars())
