...
#     WINDOWS_CLIMB_UP_DEPTH = 2
#     WINDOWS_MODULE_SCRIPT_PATH = 'AWSDevTools\\Windows'
#     WINDOWS_MODULE_SCRIPT_NAME = 'AWSDevTools-OneTimeSetup.bat'
#     WINDOWS_REPO_SCRIPT = 'AWSDevTools\\Windows\\AWSDevTools-RepositorySetup.bat'
#
#     # Linux specific constants
#     LINUX_NAME = 'Linux'
#     LINUX_CLIMB_UP_DEPTH = 3
#     LINUX_REPO_SCRIPT = 'AWSDevTools/Linux/AWSDevTools-RepositorySetup.sh'
#
#
...
#     CHAR_CODEC = 'utf-8'
#     ENABLED = 'Enabled'
#     USER_AGENT = 'ebcli ' + ebcli.__version__
#
