...
class SolutionStack(object):
    ...
    def __lt__(self, other):
        ...
        """
        try:
            # This is inside a try-catch to guard against exceptions generated by malformed
            # `ListAvailableSolutionStacks` API results
            if SOLUTION_STACK_ORDER_INDEX[self.language_name] != SOLUTION_STACK_ORDER_INDEX[other.language_name]:
                return SOLUTION_STACK_ORDER_INDEX[self.language_name] < SOLUTION_STACK_ORDER_INDEX[other.language_name]
